...
class EmailVerifyRecord(models.Model):
    ...
    send_type = models.CharField(choices=(('register', u'注册'),('forget', u'找回密码'),('update_email', u'找回密码')), max_length=20, verbose_name=u'验证码类型')
...
class Banner(models.Model):
    ...
    image = models.ImageField(default='', upload_to='banner/%Y/%m', verbose_name=u'轮播图', max_length=100)
